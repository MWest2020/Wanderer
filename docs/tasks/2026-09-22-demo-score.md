...
- [x] 1.1 De demopagina toont dezelfde score als de antwoordpagina:
...
- [x] 1.2 De kopzin leidt met de score, niet met een kale nee. Welke
...
- [x] 1.3 Een test die vastlegt dat de demopagina een score toont. Zet
