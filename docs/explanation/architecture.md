...
| Scheduler (cron)      | `internal/scheduler`                  | [`docs/scheduling.md`](../reference/scheduling.md)        |
| Read-only UI          | `internal/ui`                         | [`docs/operator.md`](../reference/operator.md)            |
...
| MaxMind GeoLite2        | `probe/ip`, egress  | Missing/corrupt DB → fail fast at startup, never mid-scan. Setup: see [`docs/operator.md`](../reference/operator.md) "GeoLite2 setup" |
...
- [`docs/scheduling.md`](../reference/scheduling.md) — cron-based scan scheduling
- [`docs/operator.md`](../reference/operator.md) — running the binary, logs, the
  read-only UI
