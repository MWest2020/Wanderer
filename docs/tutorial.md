...
- [`docs/operator.md`](operator.md) — full flag/env reference,
  troubleshooting.
- [`docs/findings.md`](findings.md) — every ProbeID with attribute
  shapes.
- [`docs/architecture.md`](architecture.md) — how the components fit
  together, how to add a probe.
- [`docs/observability.md`](observability.md) — logs, metrics, traces.
