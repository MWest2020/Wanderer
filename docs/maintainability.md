...
[ADR-0001](decisions/0001-openspec-workflow.md).
...
[ADR-0002](decisions/0002-api-stability-classes.md):
...
[`docs/`](README.md). If a flag, environment variable, or HTTP
route is added, it appears in [`docs/operator.md`](operator.md).

## Dependency policy

Policy summary (full rationale in
[ADR-0003](decisions/0003-dependency-policy.md)):
