...
- [x] 1.1 Eén functie in `internal/ui` die een Assessment omzet in een
...
- [x] 1.2 De functie geeft ook de zwaarste openstaande bevinding terug
...
- [x] 1.3 Table-driven tests: alles soeverein (7/7, 0 onbekend); één
