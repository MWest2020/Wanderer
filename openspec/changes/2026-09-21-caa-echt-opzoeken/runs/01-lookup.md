...
- [x] 1.1 `LookupCAA` doet een echte CAA-vraag (DNS-type 257). Go's
...
- [x] 1.2 Vindt hij niets, dan omhoog tot het registreerbare domein
...
- [x] 1.3 Bij erven noemt de verdicttekst de herkomst.
- [x] 1.4 Tests met een stub-resolver: eigen records, geërfd, nergens
  iets, én een test die faalt op een resolver die altijd leeg
  teruggeeft — die had de huidige fout gevangen.
- [x] 2.1 Loop de andere opzoekingen in `internal/probe/dns` en de rest
...
- [x] 2.2 docs + CHANGELOG: wat er mis was en wat eerdere CAA-oordelen
  waard waren.
