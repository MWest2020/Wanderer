...
## 1. Specs — run 01
- [ ] 1.1 `reporting-catalogue.spec.ts`, `container-image-sovereignty.spec.ts`,
  ...
  één element wijst.
- [ ] 1.2 `dar.spec.ts`: maak de kop-locator exact, zodat `/Verdict/i`
  niet twee koppen raakt.
- [ ] 1.3 Geen wijziging aan de UI-templates of -code.
