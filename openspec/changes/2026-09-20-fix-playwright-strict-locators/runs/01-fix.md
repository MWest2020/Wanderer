...
- [x] 1.1 Scope de regel-ID-locators binnen de bedoelde tabel
...
- [x] 1.2 `dar.spec.ts`: `getByRole('heading', { name: /Verdict/i })`
  raakt twee koppen op `/ui/`. Maak de match exact op de bedoelde kop.
- [x] 1.3 Raak de UI-templates en -code NIET aan. De pagina klopt; de
